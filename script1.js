...
class Cart {
    constructor() {
        // Use an object to track product id and its details plus quantity
        this.items = {}; 
    }
    ...
    removeItem(productId) {
        // If quantity is more than one, decrease it. Otherwise, remove the item.
    ...
    updateCart() {
        ...
        headerRow.innerHTML = `<span style="width:40%;">Item</span>
        ...
        addButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                // Increase the quantity by adding the product again
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    proceedButton.addEventListener('click', () => {
        ...
        if(userResponse) {
            // Create a message box and display the success message
            ...
            // Optionally remove the message box after a delay
            setTimeout(() => {
                messageBox.remove();
            }, 3000);
        }
